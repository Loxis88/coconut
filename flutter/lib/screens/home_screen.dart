...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final initialLetter =
        greetingName.isNotEmpty ? greetingName[0].toUpperCase() : 'П';
                                  ...
                                  Row(
                                    children: [
                                      const Icon(Icons.arrow_upward_rounded,
                                          color: Color(0xFF5BAF64), size: 10),
              ...
              children: [
                ...
                if (widget.history.isEmpty)
                  Padding(
                    ...
                    child: Text('Пока нет сканов.',
                        style: GoogleFonts.dmSans(color: MayakTheme.mutedFg)),
                  )
                else
                  ...widget.history
                      .take(3)
                    ...
                    return Padding(
                      ...
                      child: _RecentScanItem(
                              product: product,
                              onTap: () => widget.onShowProduct(product))
                          .animate()
                ...
                children: [
                  ...
                  Text(
                    product.manufacturer.isNotEmpty
                        ...
                        : 'Неизвестно',
                    style: GoogleFonts.dmSans(
                        fontSize: 12, color: MayakTheme.mutedFg),
                    maxLines: 1,
                    overflow: TextOverflow.ellipsis,
                  ),
            ...
            Column(
              children: [
                ...
                Text(
                  tier.label,
                  style: GoogleFonts.dmMono(
                      fontSize: 9, color: tier.color, letterSpacing: 9 * 0.03),
                ),
              ],
            ),
          ],
