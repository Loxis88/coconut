...
class CocoCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final shadow = gradient != null
        ? const BoxShadow(color: Color(0x3010b981), blurRadius: 28, offset: Offset(0, 8), spreadRadius: -4)
        : const BoxShadow(color: Color(0x141a1410), blurRadius: 20, offset: Offset(0, 4), spreadRadius: 0);
    return Container(
