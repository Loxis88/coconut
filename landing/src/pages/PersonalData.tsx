...
export default function PersonalData() {
  return (
    <LegalLayout title="Политика в отношении обработки персональных данных" updated="17 июня 2026 г.">
      <div className="prose-legal">
        ...
        <p>
          ...
          по обеспечению безопасности персональных данных, предпринимаемые Головлев Иван
          Александрович (далее — Оператор).
        </p>
        <p>
        ...
        <p>
          2.8. Персональные данные — любая информация, относящаяся прямо или косвенно к определенному
          или определяемому Пользователю веб-сайта https://foodmayak.ru.
        </p>
        <p>
        ...
        <p>
          2.10. Пользователь — любой посетитель веб-сайта https://foodmayak.ru.
        </p>
        <p>
        ...
        <ul>
          ...
          <li>
            ...
            выполнения обязанностей, предусмотренных Законом о персональных данных и принятыми
        ...
        <p>
          5.2. Обработка персональных данных ограничивается достижением конкретных, заранее определенных
        ...
        <p>
          ...
          обработки. Не допускается избыточность обрабатываемых персональных данных по отношению
        ...
        <table className="req-table">
          <tbody>
            <tr><td>Цель обработки</td><td>регистрация и авторизация Пользователя в приложении, синхронизация истории сканирований между устройствами, восстановление доступа к аккаунту, ответы на обращения и уведомления о безопасности аккаунта</td></tr>
            <tr><td>Персональные данные</td><td>адрес электронной почты; отображаемое имя (никнейм); история сканирований (штрихкоды и даты сканирований продуктов), синхронизированная с аккаунтом</td></tr>
            <tr><td>Правовые основания</td><td>согласие субъекта персональных данных на обработку его персональных данных; пользовательское соглашение между Оператором и субъектом персональных данных</td></tr>
            <tr><td>Виды обработки персональных данных</td><td>Сбор, запись, систематизация, накопление, хранение, уточнение (обновление, изменение), извлечение, использование, обезличивание, блокирование, удаление и уничтожение персональных данных. Отправка сервисных писем на адрес электронной почты</td></tr>
          </tbody>
        </table>
        ...
        <p>
          ...
          в случае, если субъектом персональных данных дано согласие Оператору на передачу данных
        ...
        <p>
          ...
          <a href="mailto:admin@foodmayak.ru"> admin@foodmayak.ru</a> с пометкой «Актуализация персональных данных».
        </p>
        <p>
          ...
          <a href="mailto:admin@foodmayak.ru"> admin@foodmayak.ru</a> с пометкой «Отзыв согласия на обработку
          персональных данных».
        </p>
        <p>
          ...
          Субъект персональных данных обязан самостоятельно своевременно ознакомиться с указанными
        ...
        <p>
          ...
          данных, разрешенных для распространения, не действуют в случаях обработки персональных данных
          в государственных, общественных и иных публичных интересах, определенных законодательством РФ.
        </p>
        ...
        <p>
          ...
          согласия субъектом персональных данных или требование о прекращении обработки персональных данных,
        ...
        <p>
          ...
          данных обязан уведомить уполномоченный орган по защите прав субъектов персональных данных о своем
          намерении осуществлять трансграничную передачу персональных данных (такое уведомление направляется
        ...
        <p>12.3. Актуальная версия Политики в свободном доступе расположена в сети Интернет по адресу https://foodmayak.ru/?page=personal-data.</p>
      </div>
    </LegalLayout>
  )
}
